...
if(isset($_REQUEST)){
    ...
    if($_REQUEST['option']=="CONFIG_ENTRY_load_type")
    {
        ...
        //CONFIG TYPE LIST
        $CONFIG_ENTRY_type = mysqli_query($con,"SELECT * FROM LMC_CONFIGURATION WHERE CNP_ID='$CONFIG_ENTRY_mod' AND (CGN_NON_IP_FLAG is null) ORDER BY CGN_TYPE ASC");
