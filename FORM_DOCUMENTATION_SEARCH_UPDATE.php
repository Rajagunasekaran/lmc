    ...
    function DT_table(){
        ...
        xmlhttp.onreadystatechange=function() {
            if (xmlhttp.readyState==4 && xmlhttp.status==200) {
                ...
                if(value_array!=null){
                    var DT_UPD_table_header='<table id="DT_tbl_htmltable" border="1"  cellspacing="0" class="srcresult"><thead  bgcolor="#6495ed" style="color:white"><tr><th></th><th>CATEGORY</th><th>DATE</th><th style="text-align:center;">FILENAME</th><th>USERSTAMP</th><th>TIMESTAMP</th></tr></thead><tbody>'
                    for(var j=0;j<value_array.length;j++){
                        ...
                        DT_UPD_table_header+='<tr><td><input type="radio" name="DT_UPD_rd_flxtbl" class="DT_UPD_class_radio" id='+id+'  value='+id+'></td><td>'+category+'</td><td nowrap>'+date+'</td><td> '+filename+'</td><td >'+userstamp+'</td><td nowrap>'+timestamp+'</td></tr>';
                    }
