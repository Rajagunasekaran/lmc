                    ...
                    if(filenamein_array!=''){
                        ...
                        for(var j=0;j<filenameinarray.length;j++){
                            ...
                            if(role=='ADMIN' || role=='SUPER ADMIN'){
                                var appendfile=' <div class="col-sm-offset-2 col-sm-10" style="padding-bottom: 5px" id='+file_count+'><a href="download.php?filename='+name+'" class="links">'+filenameinarray[j]+'</a> <input type="button" id="Del" class="submit_enable" value="X" style="background-color:red;color:white;font-size:9;font-weight: bold;"/></div>';
                            }
                            else{
                                var appendfile=' <div class="col-sm-offset-2 col-sm-10" style="padding-bottom: 5px" id='+file_count+'><a href="download.php?filename='+name+'" class="links">'+filenameinarray[j]+'</a></div>';
                                $('#attachprompt').hide();
