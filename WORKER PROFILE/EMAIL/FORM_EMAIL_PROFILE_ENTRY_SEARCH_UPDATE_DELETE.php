    ...
    <div class="panel panel-info">
        ...
        <div class="panel-body">
            ...
            <div id="divupdateform">
                <div name="EP_SRC_UPD_DEL_div_profile" id="EP_SRC_UPD_DEL_div_profile" class="form-group" hidden>
                  <label name="EP_SRC_UPD_DEL_lbl_profile" id="EP_SRC_UPD_DEL_lbl_profile" clas="col-sm-2">PROFILE NAME<em>*</em></label></td>
                  <div class="col-sm-4">
