...
//    include "COMMON.php";
    ...
    if($_REQUEST['option']=="ET_ENTRY_already_result"){
        ...
        $sql="SELECT ET_EMAIL_SCRIPT FROM LMC_EMAIL_TEMPLATE WHERE ET_EMAIL_SCRIPT='$ET_ENTRY_scriptname'";
...
//        echo "CALL SP_TS_EMAIL_TEMPLATE_INSERT('$ET_ENTRY_scriptname','$ET_ENTRY_subject','$ET_ENTRY_body','$USERSTAMP',@EMAILINSERT_FLAG)";
